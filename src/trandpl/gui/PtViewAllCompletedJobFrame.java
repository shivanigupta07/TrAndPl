...
public class PtViewAllCompletedJobFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        nameLbl1.setText("All Completed Jobs -");
        jPanel1.add(nameLbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 360, 180, 30));
        ...
        tblAllJobs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Job ID", "Job Title", "Company Name", "Skills Requried", "Percent"
            }
        ) {
        ...
        tblAllJobs.setRowSelectionAllowed(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PtViewAllCompletedJobFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
